...
2.  From the list of available media types, select **Folder**. <a href="/images/media-create-action-menu.png" target="_blank">View</a>
...
1.  Drag and drop your files in the main content area of the Media section.<p style="border-radius: .125rem; border-left-width: 4px; border-color: #1B70B5; background-color: #EDF7FF; padding: .5rem .5rem .5rem .75rem;" role="alert"><strong>NOTE:</strong>Make sure you have your folder selected first to keep your media organized. <a href="/images/media-upload-section.png" target="_blank">View</a></p>
...
2.  Below the file, additional details are listed (width, height, file size, etc.).
3.  On the **Info** tab, you can find all of the nodes on the site that reference the media item under the **Referenced By** section. The **Links** section also has the direct link to the media item. [View](https://www.natptax.com/media/nmmhxirs/media-info-tab.png) 
